...
const GROUP_SECP256R1: i32 = 0x0017;
const GROUP_SECP384R1: i32 = 0x0018;
const GROUP_SECP521R1: i32 = 0x0019;
const GROUP_X25519: i32 = 0x001d;
const GROUP_X448: i32 = 0x001e;

const EC_POINT_FORMAT_UNCOMPRESSED: i32 = 0x00;
const EC_POINT_FORMAT_ANSIX962_COMPRESSED_PRIME: i32 = 0x01;
const EC_POINT_FORMAT_ANSIX962_COMPRESSED_CHAR2: i32 = 0x02;
...
pub fn tls_versions() -> Vec<Version> {
    let ssl20 = Version {
        protocol: Protocol::SSLV20,
        ciphers: vec![
    ...
    let ssl30 = Version {
        protocol: Protocol::SSLV30,
        ciphers: ciphers_ssl30_tls10_tls11.clone(),
    };
    let tls10 = Version {
        protocol: Protocol::TLSV10,
        ciphers: ciphers_ssl30_tls10_tls11.clone(),
    };
    let tls11 = Version {
    ...
    let tls12 = Version {
        ...
        ciphers: ciphers_tls12,
    };

    vec![ssl20, ssl30, tls10, tls11, tls12]
}